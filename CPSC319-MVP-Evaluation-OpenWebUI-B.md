...
| CI/CD | Must | MVP | Jaskirat | 🟢 Done | [PR #22](https://github.com/jaskirat-gill/OpenWebUI-Project/pull/22) | CI/CD pipeline setup |
| MCP server | Must | MVP | Shibo | 🟢 Done | [PR #20](https://github.com/jaskirat-gill/OpenWebUI-Project/pull/20) · [PR #44](https://github.com/jaskirat-gill/OpenWebUI-Project/pull/44) · [Live](https://cpsc319.jaskiratgill.ca) | MCP server integration and improvements |
