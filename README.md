...
- Stdio helper script: run `/Users/sherryxia/CPSC-319/OpenWebUI-Project/scripts/run_mcp_stdio.sh`
...
- **MCP stdio transport is noisy/broken**: run `/Users/sherryxia/CPSC-319/OpenWebUI-Project/scripts/run_mcp_stdio.sh` directly. The wrapper keeps stdout protocol-clean and avoids Docker lifecycle chatter.
